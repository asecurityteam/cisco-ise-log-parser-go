...
func TestParseMessageCSV(t *testing.T) {
	...
	tc := []struct {
		...
		{
			name:            "Golden Path - 80002 event",
			log:             `80002 INFO  Profiler: Profiler EndPoint profiling event occurred, ConfigVersionId=68, OperatingSystem=Apple iOS 6.1.4 (Darwin 13.0.0), EndpointCertainityMetric=20, EndpointIPAddress=172.22.236.73, EndpointMacAddress=E0:B5:5F:C4:96:1B, EndpointMatchedPolicy=Apple-iDevice, EndpointNADAddress=172.22.230.2, EndpointOUI=Apple\\, Inc., EndpointPolicy=Apple-iDevice, EndpointProperty=cldcAssociationMode=4\\,AuthenticationIdentityStore=Internal Endpoints\\,AuthenticationMethod=Lookup\\,Security=Security#Security\\,DestinationPort=1812\\,allowEasyWiredSession=false\\,User-Fetch-StreetAddress=\\,PostureExpiry=\\,SelectedAccessService=HOST-LOOKUP-ALLOWED-PROTOCOLS\\,NetworkDeviceName=syd341-l7-wlc01\\,User-Fetch-Job-Title=\\,NAS-Port=13\\,DestinationIPAddress=172.22.16.55\\,MessageCode=3002\\,SelectedAuthenticationIdentityStores=Internal Endpoints\\,Acct-Output-Gigawords=0\\,User-Fetch-Organizational-Unit=\\,Device Type=Device Type#All Device Types#Cisco#WLC\\,User-Fetch-Last-Name=\\,User-Fetch-Telephone=\\,AuthenticationStatus=AuthenticationPassed\\,Software Version=Unknown\\,NetworkDeviceGroups=Location#All Locations#SYD#SYD341\\, Device Type#All Device Types#Cisco#WLC\\, IPSEC#Is IPSEC Device#No\\, Security#Security\\, Role#Role\\, Team#Team\\,IdentitySelectionMatchedRule=Authentication Rule 1\\,BYODRegistration=Unknown\\,OriginalUserName=e0b55fc4961b\\,Total Certainty Factor=20\\,UserType=Host\\,IdentityGroupID=d8b240e0-38ef-11e8-90a1-0242a865f195\\,Description=\\,NAS-Identifier=syd341-l7-wlc01\\,NAS-Port-Type=Wireless - IEEE 802.11\\,StepData=5= Normalised Radius.RadiusFlowType\\, 7=Internal Endpoints\\,RegistrationTimeStamp=0\\,TimeToProfile=11\\,PhoneID=\\,Framed-IPv6-Address=\\,DeviceRegistrationStatus=NotRegistered\\,RadiusFlowType=WirelessMAB\\,Team=Team#Team\\,User-Fetch-Email=\\,SSID=00-6b-f1-94-e8-10:Charlie-SE\\,CreateTime=1580715972360\\,UseCase=Host Lookup\\,StaticGroupAssignment=true\\,User-Fetch-LocalityName=\\,DTLSSupport=Unknown\\,LastActivity=1646169753403\\,User-Fetch-StateOrProvinceName=\\,LastNmapScanTime=1580777404832\\,UpdateTime=1646126772363\\,NetworkDeviceProfileId=b0699505-3150-4215-a80e-6753d45bf56c\\,NetworkDeviceProfileName=Cisco\\,PostureAssessmentStatus=NotApplicable\\,PolicyVersion=32\\,IPSEC=IPSEC#Is IPSEC Device#No\\,EndPointPolicyID=0a5b67f0-8c00-11e6-996c-525400b48521\\,operating-system=Apple iOS 6.1.4 (Darwin 13.0.0)\\,User-Fetch-CountryName=\\,Framed-IPv6-Prefix=fe80::/64\\,FirstCollection=1580715971595\\,CacheUpdateTime=1646170095792\\,Name=Endpoint Identity Groups:access-device:vc\\,IdentityPolicyMatchedRule=Authentication Rule 1\\,StaticAssignment=false\\,User-Name=E0-B5-5F-C4-96-1B\\,User-Fetch-First-Name=\\,NmapScanCount=1\\,AAA-Server=syd-isepsn01\\,User-AD-Last-Fetch-Time=1646169752061\\,Model Name=Unknown\\,User-Fetch-User-Name=E0-B5-5F-C4-96-1B\\,IsThirdPartyDeviceFlow=false\\,Device IP Address=172.22.230.2\\,PortalUser=\\,AllowedProtocolMatchedRule=Authentication Rule 1\\,Role=Role#Role\\,Calling-Station-ID=e0:b5:5f:c4:96:1b\\,FailureReason=-\\,Network Device Profile=Cisco\\,MDMServerID=\\,Called-Station-ID=a4:93:4c:b0:af:e0\\,PostureApplicable=Yes\\,User-Fetch-Department=\\,cldcClientStatus=4\\,NmapSubnetScanID=0\\,Device Identifier=\\,Airespace-Wlan-Id=12\\,cldcClientIPAddress=172.22.236.73\\,MatchedPolicyID=0a5b67f0-8c00-11e6-996c-525400b48521\\,Service-Type=Call Check\\,UserName=E0-B5-5F-C4-96-1B\\,FeedService=false\\,SelectedAuthorizationProfiles=vlan-503-VC\\,host-name=amalia.acom.atlassian\\,Response=\\{UserName=E0:B5:5F:C4:96:1B\\; User-Name=E0-B5-5F-C4-96-1B\\; Class=CACS:ac16e6020012ebcb621e8e7b:syd-isepsn01/434424888/4087191\\; Session-Timeout=28800\\; Termination-Action=RADIUS-Request\\; Tunnel-Type=(tag=1) VLAN\\; Tunnel-Medium-Type=(tag=1) 802\\; Tunnel-Private-Group-ID=(tag=1) 503\\; cisco-av-pair=profile-name=Apple-iDevice\\; LicenseTypes=1\\; \\}\\,EndPointMACAddress=E0-B5-5F-C4-96-1B\\,cldcClientAccessVLAN=503\\,Framed-IP-Address=172.22.236.73\\,AuthorizationPolicyMatchedRule=MAB VC\\,Acct-Input-Gigawords=0\\,Location=Location#All Locations#SYD#SYD341\\,UniqueSubjectID=, EndpointSourceEvent=RADIUS Probe, EndpointIdentityGroup=vc, ProfilerServer=syd-isepsn01.office.atlassian.com, #015","env":"prod","logtype":"cisco_ise_security","service_id":"eee2ae9b-c564-4943-9819-167919a5e9c1","business_unit":"Workplace Technology","aggregator":"10.104.240.192","hostname":"ip-10-104-240-192","time":"2022-03-01T21:28:15+00:00"`,
			expectedMarshal: []byte(`{"ConfigVersionID":"68","EventDescription":"Profiler EndPoint profiling event occurred","EventType":80002,"EndpointProperty":{"Hostname":"amalia.acom.atlassian","FramedIPAddress":"172.22.236.73"},"MessageDetails":{"UnexpectedFields":{"#015\",\"env\":\"prod\",\"logtype\":\"cisco_ise_security\",\"service_id\":\"eee2ae9b-c564-4943-9819-167919a5e9c1\",\"business_unit\":\"Workplace Technology\",\"aggregator\":\"10.104.240.192\",\"hostname\":\"ip-10-104-240-192\",\"time\":\"2022-03-01T21:28:15+00:00\"":"","EndpointCertainityMetric":"20","EndpointIPAddress":"172.22.236.73","EndpointIdentityGroup":"vc","EndpointMacAddress":"E0:B5:5F:C4:96:1B","EndpointMatchedPolicy":"Apple-iDevice","EndpointNADAddress":"172.22.230.2","EndpointOUI":"Apple\\, Inc.","EndpointPolicy":"Apple-iDevice","EndpointSourceEvent":"RADIUS Probe","OperatingSystem":"Apple iOS 6.1.4 (Darwin 13.0.0)","ProfilerServer":"syd-isepsn01.office.atlassian.com"}}}`),
			expectedError:   nil,
		},
		{
			name:            "Golden Path",
