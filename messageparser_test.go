...
func TestParseMessageCSV(t *testing.T) {
	...
	tc := []struct {
		...
		{
			name:            "80002 event - textEncodedORAddress is last field",
			log:             "80002 INFO Profiler: Profiler EndPoint profiling event occurred, ConfigVersionId=50, EndpointCertainityMetric=50, EndpointMacAddress=00:aa:11:bb:22:cc, EndpointMatchedPolicy=Macintosh-Workstation, EndpointOUI=REALTEK SEMICONDUCTOR CORP., EndpointPolicy=Macintosh-Workstation, EndpointProperty=AuthenticationIdentityStore=office.company.com\\,AD-User-Candidate-Identities=user@office.com\\,AuthenticationMethod=PAP_ASCII\\,Security=Security#Security#High-Security\\,AD-Fetch-Host-Name=Hostname\\, User-Fetch-StreetAddress=\\,SelectedAccessService=PAP-ALLOWED-PROTOCOLS\\,device-type=MacBookPro17\\,1\\,User-Fetch-Job-Title=Title\\,MessageCode=3001\\,SelectedAuthenticationIdentityStores=office.com\\,Device Type=Device Type#All Device Types#Cisco#Firewall\\,User-Fetch-Last-Name=Lastname\\,User-Fetch-Telephone=\\,AuthenticationStatus=AuthenticationPassed\\,Software Version=Unknown\\,NetworkDeviceGroups=Security#Security#High-Security\\, Device Type#All Device Types#Cisco#Firewall\\, IPSEC#Is IPSEC Device#No\\, Team#Team#Core Network and Automation\\, Location#All Locations\\, Role#Role\\,BYODRegistration=Unknown\\,IdentitySelectionMatchedRule=Default\\,OriginalUserName=uername\\,Total Certainty Factor=50\\,IdentityGroupID=12345-ABCD\\,AD-User-Resolved-Identities=username@office.com\\,employeeID=111111\\,NAS-Port-Type=Virtual\\,DeviceRegistrationStatus=NotRegistered\\,Team=Team#Team#Core Network and Automation\\,User-Fetch-Email=user@office.com\\,IPSEC=IPSEC#Is IPSEC Device#No\\,User-Fetch-CountryName=\\,IdentityPolicyMatchedRule=Default\\,Name=Endpoint Identity Groups:Trusted\\,IsMachineIdentity=false\\,StaticAssignment=false\\,User-Name=username\\,User-Fetch-First-Name=username\\,IdentityAccessRestricted=false\\,sAMAccountName=username\\,User-Fetch-User-Name=username\\,IsThirdPartyDeviceFlow=false\\,device-platform=mac-intel\\,Device IP Address=100.111.111\\,PortalUser=\\,AllowedProtocolMatchedRule=Default\\,Role=Role#Role\\,FailureReason=-\\,textEncodedORAddress=\\\\\"devices\": [\\\\\"deviceid\": \"12334\"\\\\ \"mac\": [\"aa:11:bb:22:33\"\\\\ \"aa:11:bb:22:33\"\\\\ \"aa:11:bb:22:33\"\\\\ \"aa:11:bb:22:33\"\\\\ \"aa:11:bb:22:33\"]\\\\]\\\\",
			expectedMarshal: []byte(`{"ConfigVersionID":"50","EndpointCertainityMetric":"50","EndPointMACAddress":"00:aa:11:bb:22:cc","EndpointMatchedPolicy":"Macintosh-Workstation","EndpointPolicy":"Macintosh-Workstation","EndpointProperty":{"ADFetchHostName":"Hostname\\, User-Fetch-StreetAddress=","ADUserCandidateIdentities":"user@office.com","ADUserResolvedIdentities":"username@office.com","AllowedProtocolMatchedRule":"Default","AuthenticationIdentityStore":"office.company.com","AuthenticationMethod":"PAP_ASCII","AuthenticationStatus":"AuthenticationPassed","BYODRegistration":"Unknown","DevicePlatform":"mac-intel","DeviceIPAddress":"100.111.111","DeviceRegistrationStatus":"NotRegistered","DeviceType":{"Value":"All Device Types","Child":{"Value":"Cisco","Child":{"Value":"Firewall"}}},"EmployeeID":"111111","FailureReason":"-","IPSEC":{"Value":"Is IPSEC Device","Child":{"Value":"No"}},"IdentityAccessRestricted":"false","IdentityGroupID":"12345-ABCD","IdentityPolicyMatchedRule":"Default","IdentitySelectionMatchedRule":"Default","IsMachineIdentity":false,"IsThirdPartyDeviceFlow":false,"MessageCode":"3001","NASPortType":"Virtual","Name":"Endpoint Identity Groups:Trusted","NetworkDeviceGroups":{"Security":{"Value":"Security","Child":{"Value":"High-Security\\, Device Type","Child":{"Value":"All Device Types","Child":{"Value":"Cisco","Child":{"Value":"Firewall\\, IPSEC","Child":{"Value":"Is IPSEC Device","Child":{"Value":"No\\, Team","Child":{"Value":"Team","Child":{"Value":"Core Network and Automation\\, Location","Child":{"Value":"All Locations\\, Role","Child":{"Value":"Role"}}}}}}}}}}}},"OriginalUserName":"uername","PortalUser":"","Role":{"Value":"Role"},"SAMAccountName":"username","Security":{"Value":"Security","Child":{"Value":"High-Security"}},"SelectedAccessService":"PAP-ALLOWED-PROTOCOLS","SelectedAuthenticationIdentityStores":"office.com","SoftwareVersion":"Unknown","StaticAssignment":false,"Team":{"Value":"Team","Child":{"Value":"Core Network and Automation"}},"TotalCertaintyFactor":"50","TextEncodedORAddress":{"devices":[{"deviceid":"12334","mac":["aa:11:bb:22:33","aa:11:bb:22:33","aa:11:bb:22:33","aa:11:bb:22:33","aa:11:bb:22:33"]}]},"UserName":"username","UserFetchCountryName":"","UserFetchEmail":"user@office.com","UserFetchFirstName":"username","UserFetchJobTitle":"Title","UserFetchLastName":"Lastname","UserFetchUserName":"username","UserFetchTelephone":"","MessageDetails":{"UnexpectedFields":{"1":""}}},"EndpointOUI":"REALTEK SEMICONDUCTOR CORP.","EventDescription":"Profiler EndPoint profiling event occurred","EventType":80002,"MessageDetails":{"UnexpectedFields":{}}}`),
			expectedError:   nil,
		},
		{
			name:            "80002 event - textEncodedORAddress is almost unfixable",
			log:             "80002 INFO  Profiler: Profiler EndPoint profiling event occurred, EndpointPolicy=Macintosh-Workstation, EndpointProperty=AuthenticationIdentityStore=office.company.com\\,Service-Type=Framed\\,textEncodedORAddress=\\\\\"devices\": [\\\\\"deviceid\": \"abcd\"\\\\ \"mac\": [\"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"]\\\\ \\\\\"deviceid\": \"xyz123\"\\\\ \"mac\": [\"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"]\\\\]\\\\FeedService=false\\,SelectedAuthorizationProfiles=VPN-StaffManaged-Policy, ProfilerServer=apx-isepsn01.office.company.com, #015",
			expectedMarshal: []byte(`{"EndpointPolicy":"Macintosh-Workstation","EndpointProperty":{"AuthenticationIdentityStore":"office.company.com","FeedService":false,"SelectedAuthorizationProfiles":"VPN-StaffManaged-Policy","ServiceType":"Framed","TextEncodedORAddress":{"devices":[{"deviceid":"abcd","mac":["11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55","aa-bb-cc-dd-ee"]},{"deviceid":"xyz123","mac":["11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55"]}]},"MessageDetails":{"UnexpectedFields":{}}},"EventDescription":"Profiler EndPoint profiling event occurred","EventType":0,"ProfilerServer":"apx-isepsn01.office.company.com","MessageDetails":{"UnexpectedFields":{}}}`),
			expectedError:   nil,
		},
		{
			name:            "80002 event - textEncodedORAddress is broken in a different way",
			log:             "80002 INFO  Profiler: Profiler EndPoint profiling event occurred, EndpointProperty=AuthenticationIdentityStore=Internal Endpoints\\,textEncodedORAddress=\\\\\"devices\": [\\\\\"mac\": [\"aa-bb-cc-dd-ee\"\\\\ null] \\\\ \"deviceid\": \"abcde\"\\\\]\\\\FeedService=false\\,UniqueSubjectID=, EndpointSourceEvent=RADIUS Probe, #015",
			expectedMarshal: []byte(`{"EndpointProperty":{"AuthenticationIdentityStore":"Internal Endpoints","FeedService":false,"TextEncodedORAddress":{"devices":[{"deviceid":"abcde","mac":["aa-bb-cc-dd-ee",""]}]},"UniqueSubjectID":"","MessageDetails":{"UnexpectedFields":{}}},"EndpointSourceEvent":"RADIUS Probe","EventDescription":"Profiler EndPoint profiling event occurred","EventType":0,"MessageDetails":{"UnexpectedFields":{}}}`),
			expectedError:   nil,
		},
		{
			name:            `80002 event - textEncodedORAddress with a new parsing corner case (]\\" is present)`,
			log:             "80002 INFO  Profiler: Profiler EndPoint profiling event occurred, EndpointProperty=AuthenticationIdentityStore=office.company.com\\,textEncodedORAddress=\\\\\"devices\": [\\\\\"deviceid\": \"abcd\"\\\\ \"mac\": [\"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"]\\\\ \\\\\"deviceid\": \"xyz123\"\\\\ \"mac\": [\"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"]\\\\\"deviceid\": \"112233\"\\\\ \"mac\": [\"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"]\\\\]\\\\FeedService=false\\,UniqueSubjectID=, EndpointSourceEvent=RADIUS Probe, #015",
			expectedMarshal: []byte(`{"EndpointProperty":{"AuthenticationIdentityStore":"office.company.com","FeedService":false,"TextEncodedORAddress":{"devices":[{"deviceid":"abcd","mac":["11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55"]},{"deviceid":"xyz123","mac":["11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55"]},{"deviceid":"112233","mac":["11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55"]}]},"UniqueSubjectID":"","MessageDetails":{"UnexpectedFields":{}}},"EndpointSourceEvent":"RADIUS Probe","EventDescription":"Profiler EndPoint profiling event occurred","EventType":0,"MessageDetails":{"UnexpectedFields":{}}}`),
			expectedError:   nil,
		},
		{
			name:            `80002 event - textEncodedORAddress with a new parsing corner case (invalid character '{' after object key:value pair)`,
			log:             "80002 INFO  Profiler: Profiler EndPoint profiling event occurred, EndpointProperty=AuthenticationIdentityStore=Internal Endpoints\\,textEncodedORAddress=\\\\\"devices\": [\\\\\"mac\": [\"11-22-33-44-55\"\\\\ null]\\\\ \"deviceid\": \"abcd\"\\\\]\\\\FeedService=false, EndpointSourceEvent=RADIUS Probe, #015",
			expectedMarshal: []byte(`{"EndpointProperty":{"AuthenticationIdentityStore":"Internal Endpoints","FeedService":false,"TextEncodedORAddress":{"devices":[{"deviceid":"abcd","mac":["11-22-33-44-55",""]}]},"MessageDetails":{"UnexpectedFields":{}}},"EndpointSourceEvent":"RADIUS Probe","EventDescription":"Profiler EndPoint profiling event occurred","EventType":0,"MessageDetails":{"UnexpectedFields":{}}}`),
			expectedError:   nil,
		},
		{
			name:            `80002 event - textEncodedORAddress with a new parsing corner case (invalid character '}' after array element)`,
			log:             "80002 INFO  Profiler: Profiler EndPoint profiling event occurred, EndpointPolicy=Windows10-Workstation, EndpointProperty=AuthenticationIdentityStore=office.company.com\\,textEncodedORAddress=\\\\\"devices\": [\\\\\"deviceid\": \"abcd\"\\\\ \"mac\": [\"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\ \"11-22-33-44-55\"]\\\\ \\\\\"deviceid\": \"xyz123\"\\\\ \"mac\": [\"11-22-33-44-55\"\\\\ \"aa-bb-cc-dd-ee\"\\\\]\\\\FeedService=false\\,SelectedAuthorizationProfiles=VPN-StaffManaged-Policy, EndpointSourceEvent=RADIUS Probe, #015",
			expectedMarshal: []byte(`{"EndpointPolicy":"Windows10-Workstation","EndpointProperty":{"AuthenticationIdentityStore":"office.company.com","FeedService":false,"SelectedAuthorizationProfiles":"VPN-StaffManaged-Policy","TextEncodedORAddress":{"devices":[{"deviceid":"abcd","mac":["11-22-33-44-55","aa-bb-cc-dd-ee","11-22-33-44-55"]},{"deviceid":"xyz123","mac":["11-22-33-44-55","aa-bb-cc-dd-ee"]}]},"MessageDetails":{"UnexpectedFields":{}}},"EndpointSourceEvent":"RADIUS Probe","EventDescription":"Profiler EndPoint profiling event occurred","EventType":0,"MessageDetails":{"UnexpectedFields":{}}}`),
			expectedError:   nil,
		},
		{
			name:            `80002 event - textEncodedORAddress with a new parsing corner case (invalid character ',' after object key)`,
			log:             "80002 INFO  Profiler: Profiler EndPoint profiling event occurred, EndpointProperty=AuthenticationIdentityStore=office.company.com\\,UserName=abcd@office.company.com\\,textEncodedORAddress=\\\\\"devices\": [\\\\\"deviceid\": \"abcd\"\\\\ \"mac\": [\"11-22-33-44-55\"\\\\ \"82-6c-72-c7-08-00\"\\\\ \"11-22-33-44-55\"\\\\ \"82-6c-72-c7-08-04\"\\\\ \"11-22-33-44-55\"\\\\ \"f0-18-98-a8-56-fa\"]\\\\ \\\\\"deviceid\": \"xyz123\"\\\\ \"11-22-33-44-55\"\\\\ \"82-4a-f3-47-88-04\"\\\\ \"11-22-33-44-55\"\\\\ \"5c-52-30-9c-ac-f3\"\\\\ \"11-22-33-44-55\"]\\\\]\\\\FeedService=false\\,UniqueSubjectID=, EndpointSourceEvent=RADIUS Probe, EndpointIdentityGroup=Trusted, ProfilerServer=axe-isesne01.office.company.",
			expectedMarshal: []byte(`{"EndpointIdentityGroup":"Trusted","EndpointProperty":{"AuthenticationIdentityStore":"office.company.com","FeedService":false,"TextEncodedORAddress":{"devices":[{"deviceid":"abcd","mac":["11-22-33-44-55","82-6c-72-c7-08-00","11-22-33-44-55","82-6c-72-c7-08-04","11-22-33-44-55","f0-18-98-a8-56-fa"]},{"deviceid":"xyz123","mac":["11-22-33-44-55","82-4a-f3-47-88-04","11-22-33-44-55","5c-52-30-9c-ac-f3","11-22-33-44-55"]}]},"UniqueSubjectID":"","UserName":"abcd@office.company.com","MessageDetails":{"UnexpectedFields":{}}},"EndpointSourceEvent":"RADIUS Probe","EventDescription":"Profiler EndPoint profiling event occurred","EventType":0,"ProfilerServer":"axe-isesne01.office.company.","MessageDetails":{"UnexpectedFields":{}}}`),
			expectedError:   nil,
		},
		{
			name:            `80002 event - textEncodedORAddress all unmarshal attempts fail`,
			log:             "80002 INFO  Profiler: Profiler EndPoint profiling event occurred, EndpointProperty=AuthenticationIdentityStore=office.company.com\\,UserName=abcd@office.company.com\\,textEncodedORAddress=\\\\\"devices\": [\\\\\"deviceid\": \"abcd\"\\\\\\\\\\-33-44-55\"]\\\\]\\\\FeedService=false\\,UniqueSubjectID=, EndpointSourceEvent=RADIUS Probe, EndpointIdentityGroup=Trusted, ProfilerServer=axe-isesne01.office.company.",
			expectedMarshal: []byte(`{"EventDescription":"Profiler EndPoint profiling event occurred","EventType":0,"MessageDetails":{"UnexpectedFields":{}}}`),
			expectedError:   &ParseError{},
		},
		{
		...
		},
		{
			...
			expectedMarshal: []byte(`{"EndpointProperty":{"AuthenticationIdentityStore":"office.company.com","UserName":"somebody","MessageDetails":{"UnexpectedFields":{}}},"EventDescription":"Profiler EndPoint profiling event occurred","EventType":0,"MessageDetails":{"UnexpectedFields":{}}}`),
			expectedError:   nil,
		},
	}
...
func TestParseTextEncodedORAddress(t *testing.T) {
	tc := []struct {
		name          string
		value         string
		expectedError error
		...
		{
			name:          "Hex decode failure",
			value:         "sasdkfjawoiej0e39j",
			expectedError: &ParseError{},
		},
	}

	for _, test := range tc {
		err := parseTextEncodedORAddress(&LogMessage{}, "textEncodedORAddress", test.value)
		assert.IsType(t, test.expectedError, err)
	}
}

func TestParseEndpointPropertyTextEncodedORAddress(t *testing.T) {
	tc := []struct {
		name          string
		value         string
		expectedError error
	...
	for _, test := range tc {
		err := parseEndpointPropertyTextEncoded(&LogMessage{}, "textEncodedORAddress", test.value)
		assert.IsType(t, test.expectedError, err)
	}
}
