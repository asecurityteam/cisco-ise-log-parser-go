...
func TestParseMessageCSV(t *testing.T) {
	...
	tc := []struct {
		...
		},
		{
			...
			expectedMarshal: []byte(`{"ConfigVersionID":"50","EndpointIdentityGroup":"Profiled","EndpointMatchedPolicy":"Apple-Device","EndpointPolicy":"Apple-Device","EndpointProperty":{"DTLSSupport":"Unknown","DestinationIPAddress":"1.1.1.1","DeviceIPAddress":"111.11.11.11","DeviceRegistrationStatus":"NotRegistered","DeviceType":{"Value":"All Device Types","Child":{"Value":"Cisco","Child":{"Value":"WLC"}}},"EndPointMACAddress":"aa:11:bb:22:cc:33","Hostname":"","IPSEC":{"Value":"Is IPSEC Device","Child":{"Value":"No"}},"Location":{"Value":"All Locations","Child":{"Value":"LOC","Child":{"Value":"LOC123"}}},"NASPort":"00","NASPortType":"Wireless - IEEE 802.11","NetworkDeviceProfile":"Cisco","NetworkDeviceGroups":{"Location":{"Value":"All Locations","Child":{"Value":"SYD","Child":{"Value":"SYD341"}}}},"NetworkDeviceName":"networkname","RadiusFlowType":"RadiusFlow123","RadiusPacketType":"Drop","Response":{"MessageDetails":{"UnexpectedFields":{"\\\\":""}}},"Role":{"Value":"Role"},"SelectedAccessService":"EAP-PEAP-ALLOWED-PROTOCOLS","StepData":"4= Normalised Radius.RadiusFlowType","Team":{"Value":"Team"},"MessageDetails":{"UnexpectedFields":{" Device Type#All Device Types#Cisco#WLC":""," IPSEC#Is IPSEC Device#No":""," Role#Role":""," Security#Security":""," Team#Team":"","BYODRegistration":"Unknown","CreateTime":"1646292764687","Device Identifier":"","FeedService":"false","LastActivity":"1234","LastNmapScanTime":"0","MDMServerID":"","MatchedPolicyID":"1234","MessageCode":"5411","NmapScanCount":"0","PhoneID":"","PolicyVersion":"32","PortalUser":"","PostureApplicable":"Yes","PostureExpiry":"","RegistrationTimeStamp":"0","StaticGroupAssignment":"false","TimeToProfile":"20","Total Certainty Factor":"10","UniqueSubjectID":"","UpdateTime":"0"}}},"EndpointOUI":"Apple\\, Inc.","EventDescription":"Profiler EndPoint profiling event occurred","EventType":80002,"MessageDetails":{"UnexpectedFields":{"#015\",\"env\":\"prod\",\"logtype\":\"cisco_ise_security\",\"service_id\":\"12345\",\"business_unit\":\"business_unit\",\"aggregator\":\"11.1.1.1\",\"hostname\":\"hostname1234\",\"time\":\"2022-03-03T19:38:16+00:00\"":"","EndpointCertainityMetric":"10","EndpointMacAddress":"aa:00:bb:11:cc:22","EndpointNADAddress":"111.11.111","EndpointSourceEvent":"RADIUS Probe","ProfilerServer":"office.com"}}}`),
			expectedError:   nil,
		},
	}
