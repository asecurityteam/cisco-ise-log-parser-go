...
func TestParseMessageCSV(t *testing.T) {
	...
	tc := []struct {
		...
		},
		{
			...
			expectedMarshal: []byte(`{"ConfigVersionID":"50","EndpointCertainityMetric":"10","EndpointIdentityGroup":"Profiled","EndPointMACAddress":"aa:00:bb:11:cc:22","EndpointMatchedPolicy":"Apple-Device","EndpointPolicy":"Apple-Device","EndpointNADAddress":"111.11.111","EndpointProperty":{"BYODRegistration":"Unknown","CreateTime":"1646292764687","DeviceIdentifier":"","DTLSSupport":"Unknown","DestinationIPAddress":"1.1.1.1","DeviceIPAddress":"111.11.11.11","DeviceRegistrationStatus":"NotRegistered","DeviceType":{"Value":"All Device Types","Child":{"Value":"Cisco","Child":{"Value":"WLC"}}},"EndPointMACAddress":"aa:11:bb:22:cc:33","FeedService":false,"Hostname":"","IPSEC":{"Value":"Is IPSEC Device","Child":{"Value":"No"}},"LastActivity":"1234","LastNmapScanTime":"0","Location":{"Value":"All Locations","Child":{"Value":"LOC","Child":{"Value":"LOC123"}}},"MatchedPolicyID":"1234","MessageCode":"5411","MDMServerID":"","NASPort":"00","NASPortType":"Wireless - IEEE 802.11","NetworkDeviceProfile":"Cisco","NetworkDeviceGroups":{"Location":{"Value":"All Locations","Child":{"Value":"SYD","Child":{"Value":"SYD341"}}}},"NetworkDeviceName":"networkname","NmapScanCount":0,"PhoneID":"","PostureApplicable":"Yes","PostureExpiry":"","PolicyVersion":"32","PortalUser":"","RadiusFlowType":"RadiusFlow123","RadiusPacketType":"Drop","RegistrationTimeStamp":"0","Response":{"MessageDetails":{"UnexpectedFields":{"\\":""}}},"Role":{"Value":"Role"},"SelectedAccessService":"EAP-PEAP-ALLOWED-PROTOCOLS","StaticGroupAssignment":false,"StepData":"4= Normalised Radius.RadiusFlowType","Team":{"Value":"Team"},"TimeToProfile":"20","TotalCertaintyFactor":"10","UniqueSubjectID":"","UpdateTime":"0","MessageDetails":{"UnexpectedFields":{" Device Type#All Device Types#Cisco#WLC":""," IPSEC#Is IPSEC Device#No":""," Role#Role":""," Security#Security":""," Team#Team":""}}},"EndpointOUI":"Apple\\, Inc.","EndpointSourceEvent":"RADIUS Probe","EventDescription":"Profiler EndPoint profiling event occurred","EventType":80002,"ProfilerServer":"office.com","MessageDetails":{"UnexpectedFields":{}}}`),
			expectedError:   nil,
		},
		{
